...
from pwmanager.crypto import (
    get_aes_mode, derive_key, derive_challenge, encrypt_data, decrypt_data,
...
def verify_passphrase(datastore: dict, encryption_key: bytes, challenge: bytes) -> bool:
    """
...
def encrypt_entry(username: str, password: str, encryption_key: bytes, cipher_mode: str) -> dict:
    ...
    Args:
        ...
        encryption_key: Encryption key (SHA-256 digest of passphrase)
